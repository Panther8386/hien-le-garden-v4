...
self.addEventListener('fetch', e => {
  ...
  if (pathname.startsWith('/admin/') || pathname === '/admin' || pathname.startsWith('/manager') || pathname.startsWith('/reception') || pathname.startsWith('/observer')) return;
