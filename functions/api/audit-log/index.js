...
const VALID_ACTION_TYPES = ['deposit_change', 'booking_cancel', 'booking_reject', 'service_void', 'account_role_change', 'account_permission_change', 'account_password_reset', 'account_delete', 'finance_transaction_create', 'finance_transaction_update', 'finance_transaction_void', 'finance_opening_balance_set', 'finance_category_create', 'finance_category_update', 'guest_identity_update', 'dine_in_menu_item_create', 'dine_in_menu_item_update', 'dine_in_order_void', 'gio_xanh_session_void', 'record_hide', 'asset_category_create', 'asset_category_update', 'asset_location_create', 'asset_location_update', 'asset_create', 'asset_update', 'asset_delete', 'asset_inventory_adjustment', 'deposit_delete'];
